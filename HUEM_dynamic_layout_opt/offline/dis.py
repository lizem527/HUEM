...
class DIS(Layout):
    def __init__(self, df, cfg, k, max_bits=16, workload=None, verbose=True, init=None):
        ...
        self.n = 3  # The number of blocks contained in table l(part)
    ...
    def _get_kcenter(self):
        ...
        with tqdm(total=1, desc="Clustering progress") as pbar:
